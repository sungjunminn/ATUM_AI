def test1(pID, rID):
    ...
    list_test_text = new_sequence[len(new_sequence) - 3:len(new_sequence)]
    ...
    print("Apriori Recommend Item : ", return_list)

    print("LSTM Recommend Item : ", lstm_biztiem)
    TNF = False
    ...
    if len(return_list) == 0 and TNF == False:
        ...
        if len(return_list) == 0 and TNF:
            ...
            if lstm_biztiem not in return_item and TNF:
                return_item_text += (", " + lstm_biztiem)
        print("Final Recommend Item : ", return_item_text)

        return return_item_text
